...
class TextAreaField(BaseField):
    ...
    def __init__(self, **kwargs):
        ...
        self.injected_css = ["fields/textarea/textarea"]
    ...
    def __editable(self) -> callable:
        ...
        def view(content_id: str, value: str | None) -> str:
            ...
            return render_template("fields/textarea/editable.html", **context)
    ...
    def __viewable(self) -> callable:
        ...
        def view(value: str | None) -> str:
            ...
            return render_template("fields/textarea/viewable.html", **context)
